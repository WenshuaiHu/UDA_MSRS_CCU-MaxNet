...
from ..model.vision_lstm_util import interpolate_sincos, to_ntuple, VitPatchEmbed, VitPosEmbed2d, DropPath
from ..model.registry import MODELS
from ..model.patch_merge_expand import PatchMerging
...
class ViLLayer(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if self.direction == "rowwise_from_top_left":
            pass
        elif self.direction == "rowwise_from_bot_right":
            x = x.flip(dims=[1])
        else:
